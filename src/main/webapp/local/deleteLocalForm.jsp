...
<%
	...
	// 파라값 유효성 체크하면서 입력안하면 다시 리스폰하여 메세지 출력
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
        ...
        <title>deleteLocalForm.jsp</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
						...
						<form action="deleteLocalAction.jsp" method="get">
							<table class="table">
									<tr>
								        <td>
								        <%
								...
								<tr>
									<td>
									<input type="text" name="deleteLocalName" value="<%=localName%>" readonly="readonly">
									</td>
									<td><%=createdate%></td>
									<td><%=updatedate%></td>
								</tr>
